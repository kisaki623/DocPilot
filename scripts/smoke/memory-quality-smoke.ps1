...
function Show-MemoryQualityPlan {
  [PSCustomObject][ordered]@{
    ...
    memoryGates = @(
      ...
      "T31 per-memory disable archives a memory and keeps it out of AGENT_MEMORY trace",
      "T31 disabled memory restore reactivates the memory after safety and governance checks",
      "T31 cross-user disable/restore and restore-after-delete are blocked",
