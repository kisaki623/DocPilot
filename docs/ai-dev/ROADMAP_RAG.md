...
- This is a conservative retrieval engineering feature, not LLM query planning or a proven real-provider relevance uplift claim. Runtime quality claims still require explicit enabled smoke / eval evidence.
