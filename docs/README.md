...
2. `docs/ai-dev/CURRENT_TASK.md`：确认当前要做的任务。`RAG Quality Upgrade v8`、Phase 2 真实体验审计修复和 Phase 3 小规模真实 rerank provider 验证已完成；下一步若继续提升真实效果，优先设计更难的 rerank uplift eval / smoke case。
