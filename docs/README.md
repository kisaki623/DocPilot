...
2. `docs/ai-dev/CURRENT_TASK.md`：确认当前要做的任务。`RAG Quality Upgrade v8`、Phase 2 真实体验审计修复、Phase 3 小规模真实 rerank provider 验证、RAG Real QA Eval v1、Memory Quality Eval v1 和 Frontend UX Audit v1 已完成；当前可继续进入 Quality Loop v2.1 的更窄体验切片。
