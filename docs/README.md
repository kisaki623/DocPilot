...
2. `docs/ai-dev/CURRENT_TASK.md`：确认当前要做的任务。`RAG Quality Upgrade v8` 和 Phase 2 真实体验审计修复已完成；当前进入 Phase 3 小规模真实 rerank provider 实效验证，重点判断 rerank / hybrid 是否真的改善召回与 citation。
