-- Demo fresh-volume bootstrap extension.
-- This file is executed by MySQL only when docker-compose.demo.yml creates an empty data volume.
-- Scope: RAG chunking, knowledge bases, conversation context, trace and user memory.
